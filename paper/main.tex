...
\affil[1]{Submission under double-blind review}
...
asymmetric unperturbed distribution. An accompanying interactive
atlas lets readers browse features by markers, cell types, niches,
and circuits; its URL is withheld during anonymous review.
\end{abstract}
...
scripts, per-control outputs, and paper source) is released in an
anonymous repository; its URL is withheld during anonymous review
and will be added to the camera-ready version. The interactive
atlas frontend and its deployment URL are likewise withheld.
...
\bibitem[Anonymous, 2026]{sae_atlas}
Anonymous (2026).
\newblock Sparse autoencoder atlases for single-cell foundation models.
\newblock Preprint; citation withheld during anonymous review.
